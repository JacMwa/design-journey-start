        ...
        <div>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <a href="mailto:yourname@example.com" className="text-portfolio-blue hover:underline">
                  jacklinematindi91@gmail.com
                </a>
              </div>
            </div>
          ...
          <div className="mt-10">
            ...
            <div className="flex space-x-4">
              {/* These are social media icons */}
              <a href="#" className="bg-gray-200 hover:bg-portfolio-blue hover:text-white p-3 rounded-full transition-colors">
